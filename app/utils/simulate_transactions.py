...
def generate_random_buy_transaction():
    ...
    with app.app_context():
        ...
        price = stock.price
        process_transaction(user_id, stock_id, quantity, price, "buy")
        print(f"[SIMULATION] Buy transaction created: User {user_id}, Stock {stock_id}, Quantity {quantity}, Price {price}")
